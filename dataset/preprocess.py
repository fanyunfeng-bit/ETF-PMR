...
# get iid or non-iid data
def non_iid_dataset(dataset, iid: bool, alpha, mode='train'):
    # seed = 190
    ...
    if dataset == 'CREMAD':
        ...
        for ii in range(len(class_dict), 0, -1):
            num_perclass.append(max_num//ii)
        print(num_perclass)
...
non_iid_dataset(dataset='CREMAD', iid=False, alpha=3)
